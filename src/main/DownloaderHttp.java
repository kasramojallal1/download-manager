...
public class DownloaderHttp extends Thread {
    ...
    /**
     * constructor of the DownloaderHttp class
     * @param file1 file
     */
    public DownloaderHttp(main.File file1){
        this.file1 = file1;
    }

    /**
     * method to download http files
     * @param file file
     * @throws IOException exception
     */
    public static void downloadFileHttp(main.File file) throws IOException{
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            String saveFilePath = SettingsWindow.saveDirectory + File.separator + file.getName();

            FileOutputStream outputStream = new FileOutputStream(saveFilePath);

            RunProgressBarHttp progressBar = new RunProgressBarHttp(file);
            progressBar.start();
            ...
            Thread threadDownloadSpeed = new Thread(new Runnable() {
                ...
                public void run() {
                    while (!file.isDownloaded()){
                        file.getLabelSpeed().setText("Speed:    " + String.valueOf(file.getDownloadSpeed()) + "  MB/S");
                        try {
                            Thread.sleep(100);
